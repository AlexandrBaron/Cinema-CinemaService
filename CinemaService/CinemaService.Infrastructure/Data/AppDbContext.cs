namespace CinemaService.Infrastructure.Data
{
    public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            var hall1Id = Guid.Parse("b3051f33-d3d6-4253-8c6d-2c14a99facf1");
            var hall2Id = Guid.Parse("b3051f33-d3d6-4253-8c6d-2c14a99facf2");
            var hall3Id = Guid.Parse("b3051f33-d3d6-4253-8c6d-2c14a99facf3");


            optionsBuilder.UseSeeding((context, _) =>
            {
                var hall1 = new Hall() { Name = "Sál 1", Status = 0, Id = hall1Id};
                ...
                var hall2 = new Hall() { Name = "Sál 2", Status = 0, Id = hall2Id };
                ...
                var hall3 = new Hall() { Name = "Sál 3", Status = 0, Id = hall3Id };
